 ...
 * @author ruman
 */
public class FeatherfallElement extends Element
{
    ...
    public FeatherfallElement(String id, String description, String... name)
    {
    ...
    public void enchant(ItemStack stack, int level)
    {
        if(level > 0)
        {
            stack.addUnsafeEnchantment(Enchantment.PROTECTION_FALL, level);
        }
    }
    ...
    {      
        ...
        else
        {
            ...
            LevitationElement.playRadiusEffect(caster, level, Effect.SPELL, 0);
