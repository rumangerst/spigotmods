 ...
 * @author ruman
 */
public class ShieldElement extends Element
{
    ...
    public ShieldElement(String id, String description, String... name)
    {
    ...
    public void enchant(ItemStack stack, int level)
    {
        if(level > 0)
        {
            stack.addUnsafeEnchantment(Enchantment.PROTECTION_ENVIRONMENTAL, level);
        }
    }
